...
from pychamp.io import read
from pychamp.method import CDA
...
def main():
    ...
    data1 = read(args.file1, loglevel=loglevel)
    data2 = read(args.file2, loglevel=loglevel)
    data3 = read(args.file3, loglevel=loglevel)
